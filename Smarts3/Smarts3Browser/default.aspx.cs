...
namespace Smarts3Browser
{
    public partial class @default : PageBase
    {
        ...
        protected void ddlLevelList_SelectedIndexChanged(System.Object sender, System.EventArgs e)
        {
            SqlConnection sqlConn = SMARTSConnectionOpen();
        ...
        protected void ddlReportLevel_SelectedIndexChanged(System.Object sender, System.EventArgs e)
        {
	        SqlConnection sqlConn = SMARTSConnectionOpen();
        ...
        protected void ddlSearchLevel_SelectedIndexChanged(System.Object sender, System.EventArgs e)
        {
	        SqlConnection sqlConn = SMARTSConnectionOpen();
        ...
        protected void ddlTypeList_SelectedIndexChanged(System.Object sender, System.EventArgs e)
        {
	        SqlConnection sqlConn = SMARTSConnectionOpen();
        ...
        protected void btnSearchValue_Click(System.Object sender, System.EventArgs e)
        {
        ...
        protected void ViewDetails_Click(System.Object sender, System.EventArgs e)
        {
	        string strSQL = "EXEC GetItem " + Common.TABLE_SHAPE + "," + Convert.ToInt32(ddlList.SelectedItem.Value) + ";";
	        SqlConnection sqlConn = SMARTSConnectionOpen();
	        SqlCommand sqlCmd = new SqlCommand(strSQL, sqlConn);
        ...
        protected void btnViewReport_Click(System.Object sender, System.EventArgs e)
        {
