<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Step.aspx.cs" Inherits="Smarts3Browser.Step" %>
    ...
    <table id="tblSystems" cellspacing="3" cellpadding="3" style="width: 95%; text-align: center">
                ...
                <table style="width: 100%">
                    <tr>
                        <td valign="top" align="left" style="width: 60%">
                            <h6>
                                Shapes in the <b>Process Steps</b> level are contained by a <b>Business Process</b>,
                                use <b>Objects</b>, have <b>Attributes</b> and <b>Artifacts</b>, and contain/relate
                                to other <b>Process Steps</b>.</h6>
                        </td>
                        <td style="width: 5%">
                        </td>
                        <td align="right" style="width: 35%">
                            <h6>
                                ...
                                <a href="../Smarts3Admin/step.aspx?id=<%=Request.QueryString["id"]%>&type=<%=Request.QueryString["type"]%>">
                                    Edit This Process Step</a><br />
        ...
        <tr>
            <td>
                <asp:DataGrid ID="grdName" BorderWidth="1px" Style="width: 100%" HeaderStyle-Font-Size="10pt"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="Business Process" HeaderStyle-Width="40%" ItemStyle-Width="40%">
                            <ItemTemplate>
                                <asp:HyperLink ID="urlBusinessProcess" runat="server" NavigateUrl='<%# "businessprocess.aspx?id=" 
                ...
                <h5>
                    <label>
                        CONTAINS Process Steps of Business Processes</label></h5>
                ...
                <h5>
                    <label>
                        USES Objects of Systems</label></h5>
                <asp:DataGrid ID="grdStepObject" Style="width: 100%" runat="server" BorderWidth="1px"
                    ...
                    <Columns>
                        <asp:TemplateColumn HeaderText="System" ItemStyle-Width="29%" HeaderStyle-Width="29%">
                            <ItemTemplate>
                                <asp:HyperLink ID="urlStepObjectSystem" runat="server" NavigateUrl='<%# "sys.aspx?id=" 
                        ...
                        <asp:TemplateColumn HeaderText="Object" ItemStyle-Width="35%" HeaderStyle-Width="35%">
                            <ItemTemplate>
                                <asp:HyperLink ID="urlStepObjectObject" runat="server" NavigateUrl='<%# "object.aspx?id=" 
                                            + DataBinder.Eval(Container.DataItem, "Related_ID") 
                                            + "&type=" 
                ...
                <h5>
                    <label>
                        RELATIONS with Process Steps of Business Processes</label></h5>
                <asp:DataGrid ID="grdRelations" Style="width: 100%" runat="server" BorderWidth="1"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="Business Process" ItemStyle-Width="25%" HeaderStyle-Width="25%">
                            <ItemTemplate>
                                <asp:HyperLink runat="server" NavigateUrl='<%# "businessprocess.aspx?id=" 
                                            + DataBinder.Eval(Container.DataItem, "RelatedContainer_ID") 
                                            + "&type=" 
                                            + DataBinder.Eval(Container.DataItem, "RelatedContainer_TypeID")%>' ID="urlRelationRelatedContainer">
                        ...
                        <asp:TemplateColumn HeaderText="Step/Decision" ItemStyle-Width="25%" HeaderStyle-Width="25%">
                            <ItemTemplate>
                                <asp:HyperLink runat="server" NavigateUrl='<%# "step.aspx?id=" 
                                            + DataBinder.Eval(Container.DataItem, "Related_ID") 
                                            + "&type=" 
                                            + DataBinder.Eval(Container.DataItem, "Related_TypeID")%>' ID="urlRelationRelated">
											<%# DataBinder.Eval(Container.DataItem, "Related_Name")%>
                                </asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateColumn>
