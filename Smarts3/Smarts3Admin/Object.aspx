<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Object.aspx.cs" Inherits="Smarts3Admin.Object" %>
                ...
                <table width="100%">
                    <tr>
                        <td align="left" valign="top" width="60%">
                            <h6>
                                Shapes in the <b>Object</b> level are contained by a <a href="sys.aspx">System</a>,
                                hosted by <a href="device.aspx">Devices</a>, used by <a href="step.aspx">Process Steps</a>,
                                contain <b>Functional Pieces</b>, have <b>Attributes</b> and <a href="artifact.aspx">
        ...
        <tr>
            <td>
                <table width="100%">
                    <tr>
                        <td width="33%">
                            <font style="font-weight: bold; font-family: Arial" size="2">SYSTEM &nbsp;&nbsp;</font>
                        </td>
                        <td width="33%">
                        ...
                        <td width="34%">
                            <font style="font-weight: bold; font-family: Arial" size="2">NAME &nbsp;&nbsp;<a
                                ...
                                href="List.aspx?list=<%=LIST_OBJECTS%>" target="_blank"> View All Objects</a></font>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:DropDownList ID="ddlSystemList" AutoPostBack="True" Width="100%" runat="server"
        ...
        <tr>
            <td>
                <asp:DataGrid ID="grdName" Width="100%" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="ShapeType" HeaderStyle-Width="25%" ItemStyle-Width="25%">
                            <ItemTemplate>
                                <%# DataBinder.Eval(Container.DataItem, "Principal_TypeName") %></ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="System" HeaderStyle-Width="30%" ItemStyle-Width="30%">
                            <ItemTemplate>
                                <asp:HyperLink ID="urlSystem" runat="server" NavigateUrl='<%# "sys.aspx?id=" + DataBinder.Eval(Container.DataItem, "PrincipalContainer_ID")%>'>
                ...
                <%--
						...
						<asp:datagrid id="grdArtifacts" Width="100%" Runat="server" BorderWidth="1" OnItemDataBound="ControlItemDataBound"
							...
							<Columns>
								...
								<asp:TemplateColumn ItemStyle-HorizontalAlign="Left" ItemStyle-Width="15%" FooterStyle-Width="15%">
									<ItemTemplate>
                ...
                <h5>
                    ...
                    <a href="step.aspx"><b>Process Steps</b></a> of <a href="businessprocess.aspx"><b>Business
                        Processes</b></a></h5>
                <asp:DataGrid ID="grdStepObject" Width="100%" runat="server" BorderWidth="1" ItemStyle-HorizontalAlign="Left"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="Process Step" ItemStyle-Width="25%" HeaderStyle-Width="25%">
                            <ItemTemplate>
                                <asp:HyperLink ID="urlStepObject" runat="server" 
                                    NavigateUrl='<%# "Step.aspx?id=" + DataBinder.Eval(Container.DataItem, "Related_ID") + "&type=" + DataBinder.Eval(Container.DataItem, "Related_TypeID") %>'>
											<%# DataBinder.Eval(Container.DataItem, "Related_Name")%>
                                </asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                ...
                <h5>
                    <label>
                        HOSTED BY</label>
                    <a href="device.aspx"><b>Devices</b></a></h5>
                <asp:DataGrid ID="grdDeviceObject" Width="100%" runat="server" BorderWidth="1" ItemStyle-HorizontalAlign="Left"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="Device" ItemStyle-Width="25%" HeaderStyle-Width="25%">
                            <ItemTemplate>
                                <asp:HyperLink ID="urlDeviceObjectServer" runat="server" NavigateUrl='<%# "Device.aspx?id=" + DataBinder.Eval(Container.DataItem, "Related_ID") + "&type=" + DataBinder.Eval(Container.DataItem, "Related_TypeID") %>'>
											<%# DataBinder.Eval(Container.DataItem, "Related_Name")%>
                                </asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                ...
                <asp:DataGrid ID="grdRelations" Width="100%" runat="server" BorderWidth="1" OnItemDataBound="ControlItemDataBound"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="System" ItemStyle-Width="25%" HeaderStyle-Width="25%">
                            <ItemTemplate>
                                <asp:HyperLink runat="server" NavigateUrl='<%# "sys.aspx?id=" + DataBinder.Eval(Container.DataItem, "RelatedContainer_ID") + "&type=" + DataBinder.Eval(Container.DataItem, "RelatedContainer_TypeID")%>'
                                    ID="urlRelationSystem">
											<%# DataBinder.Eval(Container.DataItem, "RelatedContainer_Name")%>
                                </asp:HyperLink>
                            </ItemTemplate>
                            <FooterTemplate>
                                <asp:DropDownList ID="ddlRelatedSystem" OnSelectedIndexChanged="DataBindDependentList"
