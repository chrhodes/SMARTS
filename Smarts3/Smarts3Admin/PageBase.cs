...
namespace Smarts3Admin
{
    ...
    {
        public static SqlConnection SMARTSConnectionOpen()
        {
        ...
        //    '    sqlConn = SqlConnection.GetConnection("SMARTS")
        ...
        //        if (sqlTable.Rows[i].Item("Related_ID") == intValue) {
        //            //--- linked already
        //            return false;
        ...
        public static ListItem CreateListItem(string strText)
        {
	        ...
	        lstItem.Value = Smarts3.Common.EMPTY_INT.ToString();
