<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Relation.aspx.vb" Inherits="SMARTSAdmin.Relation" %>
						...
						<asp:datagrid id="grdName" Runat="server" OnEditCommand="ControlEdit" BorderWidth="1px" Width="100%"
							...
							<Columns>
								...
								<asp:TemplateColumn HeaderText="Name" HeaderStyle-Font-Size="10pt" HeaderStyle-BackColor="#000099" HeaderStyle-ForeColor="#ffffff"
									...
									<EditItemTemplate>
										<asp:TextBox ID="txtName" Runat="server" Font-Name="Arial" Width="100%" text='<%# DataBinder.Eval(Container.DataItem, "Assoc_Name") %>'></asp:TextBox>
									</EditItemTemplate>
								</asp:TemplateColumn>
							</Columns>
						</asp:datagrid>
						<asp:datagrid id="grdDescription" Runat="server" OnEditCommand="ControlEdit" BorderWidth="1" Width="100%"
							AutoGenerateColumns="False" OnUpdateCommand="ControlUpdate"	oncancelcommand="ControlCancel" Font-Name="Arial">
							<Columns>
