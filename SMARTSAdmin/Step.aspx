<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Step.aspx.vb" Inherits="SMARTSAdmin._Step" %>
...
//-->
		...
		<script language="javascript" event="ondblclick" for="document">
<!--
						...
						<asp:datagrid id="grdName" Width="100%" Runat="server" AutoGenerateColumns="False" BorderWidth="1px"
							...
							<Columns>
								...
								<asp:TemplateColumn HeaderText="Name" HeaderStyle-Width="30%" ItemStyle-Width="30%">
									...
									<EditItemTemplate>
										<asp:TextBox ID="txtName" Runat="server" Font-Name="Arial" Width="100%" Text='<%# DataBinder.Eval(Container.DataItem, "Principal_Name") %>'></asp:TextBox>
									</EditItemTemplate>
								</asp:TemplateColumn>
