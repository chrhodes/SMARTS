...
Public Class BaseClass
    ...
    Public Shared Function SMARTSConnectionOpen() As PLDbConnection
        ...
        Try
            ...
            xmlDoc.Load(Application.StartupPath & "\SMARTS.xml")

            Dim strConn As String = xmlDoc.getElementsByTagName("DBConnection").item(0).text
            strConn = Replace(strConn, """", "")
            'Replace(xmlDoc.GetElementsByTagName("DBConnection").Item(0).ToString, """", "")
