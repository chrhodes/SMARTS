<%@ Page Language="vb" AutoEventWireup="false" Inherits="SmartsBrowser._Object" Codebehind="Object.aspx.vb" %>
				...
				<tr>
					<td>
						<asp:datagrid id="grdName"  BorderWidth="1px" style="width:100%" HeaderStyle-Font-Size="10pt"
							...
							HeaderStyle-Font-Bold="True" HeaderStyle-HorizontalAlign="left" Runat="server" AutoGenerateColumns="False">
							<Columns>
						...
						<asp:datagrid id="grdAttribute" BorderWidth="1px" style="width:100%" HeaderStyle-Font-Size="10pt"
							...
							<Columns>
								...
								<asp:TemplateColumn HeaderStyle-Font-Size="10pt" HeaderStyle-Width="43%" HeaderStyle-BackColor="#000099"
									HeaderStyle-ForeColor="#ffffff" ItemStyle-Font-Size="10pt" HeaderStyle-Font-Bold="True" HeaderStyle-HorizontalAlign="left"
									HeaderText="Value">
									<ItemTemplate>
						...
						<asp:datagrid id="grdStepObject" style="width:100%" Runat="server" BorderWidth="1" ItemStyle-HorizontalAlign="Left"
							...
							<Columns>
								...
								<asp:BoundColumn ItemStyle-Width="50%" HeaderStyle-Width="50%" HeaderText="Description" HeaderStyle-HorizontalAlign="left"
									ItemStyle-HorizontalAlign="Left" DataField="Related_Desc"></asp:BoundColumn>
							</Columns>
						</asp:datagrid><br/>
						<h5><label>HOSTED BY Devices</label></h5>						
						<asp:datagrid id="grdDeviceObject" style="width:100%" Runat="server" BorderWidth="1" ItemStyle-HorizontalAlign="Left"
							ItemStyle-Font-Size="10pt" HeaderStyle-HorizontalAlign="left" HeaderStyle-Font-Bold="True"
							HeaderStyle-Font-Size="10pt" autogeneratecolumns="False" HeaderStyle-ForeColor="#ffffff" HeaderStyle-BackColor="#000099">
							<Columns>
								<asp:BoundColumn ItemStyle-Width="25%" HeaderStyle-Width="25%" HeaderText="Environment" HeaderStyle-HorizontalAlign="left"
