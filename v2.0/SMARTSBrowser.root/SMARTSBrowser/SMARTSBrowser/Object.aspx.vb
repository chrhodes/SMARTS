...
#End Region
    ...
    Public Sub DataBindPage(ByVal sqlConn As PLDBConnection)
        ...
        strSQL = "EXEC GetItem_Container " & TABLE_SHAPE & "," & Request.QueryString("id") & "," & ABSTRACTION_SYSTEMOBJECT
        ...
        strSQL = "EXEC GetItem_Relation NULL," & TABLE_SHAPE & "," & Request.QueryString("id") & "," & ABSTRACTION_OBJECT
        sqlCmd = New PLDbCommand(strSQL, sqlConn)
        sqlTable = sqlCmd.ExecuteDataTable
        grdRelations.DataSource = sqlTable
        grdRelations.DataBind()

        strSQL = "EXEC GetItem_Container " & TABLE_SHAPE & "," & Request.QueryString("id") & "," & ABSTRACTION_DEVICEOBJECT
        sqlCmd = New PLDbCommand(strSQL, sqlConn)
        sqlTable = sqlCmd.ExecuteDataTable
        grdDeviceObject.DataSource = sqlTable
        grdDeviceObject.DataBind()

        strSQL = "EXEC GetItem_Container " & TABLE_SHAPE & "," & Request.QueryString("id") & "," & ABSTRACTION_STEPOBJECT
        sqlCmd = New PLDbCommand(strSQL, sqlConn)
        sqlTable = sqlCmd.ExecuteDataTable
